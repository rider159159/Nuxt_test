...
var firebaseApiKey = "AIzaSyBpyaspqWf2iWyLz23KzyF3MtXDE6TnwS4" //填上firebase 的 api key (不能填 nuxt.config.js 裡的 process env)

var process_url = "http://localhost:3013"; //填上你開發環境的網址
if(process.env.NODE_ENV == "prod") process_url = "https://ryder-nuxt.website"; //填上你生產環境的網址
